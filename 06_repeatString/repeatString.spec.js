...
describe('repeatString', () => {
  test('repeats the string', () => {
    expect(repeatString('Kwabena', 3)).toEqual('KwabenaKwabenaKwabena');
  });
  test('repeats the string many times', () => {
    expect(repeatString('Kwabena', 10)).toEqual('KwabenaKwabenaKwabenaKwabenaKwabenaKwabenaKwabenaKwabenaKwabenaKwabena');
  });
  test('repeats the string 1 time', () => {
    expect(repeatString('Kwabena', 1)).toEqual('Kwabena');
  });
  test('repeats the string 0 times', () => {
    expect(repeatString('Kwabena', 0)).toEqual('');
  });
  ...
  test('returns ERROR with negative numbers', () => {
    expect(repeatString('Kwabena', -1)).toEqual('ERROR');
  });
